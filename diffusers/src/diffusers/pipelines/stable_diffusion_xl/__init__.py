...
try:
    ...
    _import_structure["pipeline_stable_diffusion_xl_guni"] = ["StableDiffusionXLPipeline_guni"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_xl_guni import StableDiffusionXLPipeline_guni
