    ...
    def _create_and_replace(
        ...
        **optional_kwargs,
        ...
        if isinstance(target, LoraLayer) and not isinstance(target, AdaLoraLayer):
            ...
            # guni
            kwargs["place_in_unet"] = optional_kwargs.pop("place_in_unet", None)
            kwargs["self_or_cross"] = optional_kwargs.pop("self_or_cross", None)
            kwargs["attn_type"] = optional_kwargs.pop("attn_type", None)
            kwargs["heads"] = optional_kwargs.pop("heads", None)
